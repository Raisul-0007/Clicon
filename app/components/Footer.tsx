  ...
  return (
    <div className='bg-gray-900 py-10'>
      <Container className="lg:flex justify-between">
        ...
        <div className="lg:w-2/5 py-5 flex justify-center gap-25">
        ...
        <div className="lg:w-2/5 py-5 font-publicSans text-white ">
          <h4 className='text-white text-lg pb-4'>Download APP</h4>
