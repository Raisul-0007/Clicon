        ...
        <div className="flex justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="">
              ...
              <p className='text-[#5F6C72] text-[12px]'>Delivery in 24/H</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="">
              ...
              <p className='text-[#5F6C72] text-[12px]'>100% money-back guarantee</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="">
              ...
              <p className='text-[#5F6C72] text-[12px]'>Your money is safe</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="">
              <h4>Support 24/7</h4>
              <p className='text-[#5F6C72] text-[12px]'>Live contact/message</p>
            </div>
          </div>
        </div>
      </Container>
