  ...
  return (
    <div className='bg-[#1B6392]'>
      <Container className="w-150 py-15">
        <h3 className='font-publicSans text-[32px] font-semibold text-white text-center'>Subscribe to our newsletter</h3>
        <p className='font-publicSans text-sm text-gray-300 text-center py-5 px-15'>Praesent fringilla erat a lacinia egestas. Donec vehicula tempor libero et cursus. Donec non quam urna. Quisque vitae porta ipsum.</p>
