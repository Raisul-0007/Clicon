    ...
    <Container>
      ...
      <div className="">
        ...
        <div key={item.id} className="">
           <div className="flex ">
          <div className="w-2/5 py-3 border border-t-0 border-r-0 border-[#dbdbdb]  flex justify-center items-center gap-5">
          ...
          <div className="w-1/5 py-3 border border-t-0 border-r-0 border-[#dbdbdb] flex items-center justify-center">
          ...
          <div className="w-1/5 py-3 flex justify-center items-center border border-t-0  border-[#dbdbdb]">
          ...
          <div className="">
            {cartData.length > 0 &&(
              <div className="flex justify-center">
                <Link className='bg-[#1b6392] py-3 px-8 text-white cursor-pointer rounded-xl' href="/checkout">checkout</Link>
              </div>
            )}
          </div>
       </div>
